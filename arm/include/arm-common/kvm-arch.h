...
#define ARM_PL011_BASE		ARM_MMIO_AREA
#define ARM_PL011_SIZE		_AC(0x0000000000001000, UL)
#define ARM_PL011_MMIO_SIZE	_AC(0x0000000000010000, UL)
...
#define ARM_FREE_MMIO_AREA	(ARM_MMIO_AREA + ARM_PL011_MMIO_SIZE)
#define KVM_VIRTIO_MMIO_AREA	ARM_FREE_MMIO_AREA
